export const archiveProjectsData = [
  ...
  },
  {
    ...
    description:
      "Dual-provider AI service orchestrating local (Ollama) and cloud (Gemini) LLMs with intelligent fallback logic and deterministic JSON parsing.",
    stack: ["Flask", "Next.js", "Zustand", "Pydantic"],
    link: "https://github.com/Abubakr-Alsheikh/promptcraft-dungeon",
  },
  {
