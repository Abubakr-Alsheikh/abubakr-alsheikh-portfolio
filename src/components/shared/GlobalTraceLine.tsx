...
export const BranchCenterToLeft = () => {
  ...
  const draw1 = useTransform(scrollYProgress, [0, 0.4], [0, 1]);
  const draw2 = useTransform(scrollYProgress, [0.4, 0.7], [0, 1]);
  const draw3 = useTransform(scrollYProgress, [0.7, 1], [0, 1]);

  return (
    <div className="w-full relative h-32 md:h-48 z-10 -my-1 pointer-events-none">
