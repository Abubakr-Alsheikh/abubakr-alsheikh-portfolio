...
const LearningPlatformVisual = () => (
  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-indigo-950 to-slate-950 relative overflow-hidden group">
...
const PromptCraftVisual = () => (
  <div className="w-full h-full flex items-center justify-center bg-[#0F172A] relative overflow-hidden group">
    ...
    <div className="w-[90%] font-mono text-xs text-slate-300 p-6 bg-slate-950 rounded-xl border border-slate-800 shadow-2xl opacity-90 group-hover:opacity-100 transition-opacity">
      ...
      <div className="space-y-1">
        <p><span className="text-purple-400">class</span> <span className="text-yellow-300">LootItem</span>(BaseModel):</p>
        <p className="pl-4">name: <span className="text-blue-400">str</span></p>
        <p className="pl-4">rarity: <span className="text-blue-400">float</span> = <span className="text-green-400">0.05</span></p>
        <p className="pl-4 mb-2">effects: <span className="text-blue-400">List</span>[Effect]</p>
        <p><span className="text-slate-500"># AI Fallback Logic triggered...</span></p>
        <p><span className="text-green-500">{`>>> Gemini API: 200 OK`}</span></p>
      </div>
    </div>
  </div>
);
...
const GhosnVisual = () => (
  <div className="w-full h-full flex items-center justify-center bg-emerald-950/30 relative overflow-hidden group">
    <div className="w-[180px] h-[320px] bg-slate-950 border-4 border-slate-800 rounded-[2rem] shadow-2xl relative overflow-hidden group-hover:-translate-y-2 transition-transform duration-500">
      ...
      <div className="absolute bottom-4 right-4 bg-emerald-600 text-white text-[10px] p-2 rounded-l-lg rounded-t-lg shadow-lg">
...
export default function Projects({ data }: { data: Project[] }) {
  ...
  return (
    <section className="relative w-full py-20 lg:py-32 bg-[#020617] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 mb-16">
        ...
        >
           ...
           <span className="text-orange-500 font-mono text-sm tracking-wider uppercase">Featured Work</span>
        </motion.div>
        ...
        <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
          Architecting scalable backend logic. Crafting fluid frontend experiences. 
          Here are the production systems I&apos;ve engineered.
        </p>
      </div>
